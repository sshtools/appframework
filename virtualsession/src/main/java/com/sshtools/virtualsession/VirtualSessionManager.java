...
public interface VirtualSessionManager {
  ...
  /**
   * Add a <code>VirtualSessionManagerListener</code> to the list that should receive events
  ...
  /**
   * Removes a <code>VirtualSessionManagerListener</code> from the list that should
