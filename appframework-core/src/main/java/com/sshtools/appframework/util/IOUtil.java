...
public class IOUtil {
  ...
  /**
   * Close an <code>InputStream</code>, ignoring if the reference is null 
  ...
  /**
   * Close an <code>OutputStream</code>, ignoring if the reference is null 
   * or an exception is thrown.
   *
   ...
   * the input stream reaches end of file. It is up to the caller to flush
