...
public class ColorComboBox
  ...
  protected void fireChangeEvent() {
    ...
    ChangeListener[] l = listenerList.getListeners(
...
//      setBorder(BorderFactory.createEmptyBorder(0, 16, 0, 0));
    ...
    public Component getListCellRendererComponent(JList list, Object value,
      ...
      if (c == null) {
        setIcon(new ArrowIcon(ArrowIcon.EAST, UIManager.getColor("controlShadow"), UIManager.getColor("Button.foreground"), UIManager
        ...
        icon.setColor(c);
        setIcon(icon);
        //  Set the text. If the background is a well known one with a name, render
