...
public class ActionButton extends JButton {
	...
	/**
	 * Creates a new ToolButton object from an AppAction. The key for the icon
	 * value will be {@link AppAction.MEDIUM_ICON}. If the action has a property
	 * with a name of {@link AppAction.TEXT_ON_TOOLBAR}and a value of
	...
	/**
	 * Creates a new ToolButton object from an AppAction. If useToolIcon is
	 * true, then the icon will be retrieved using the
