...
public abstract class AbstractSaveAction extends AbstractAppAction {
	...
	public AbstractSaveAction(boolean onToolBar) {
		...
		putValue(SMALL_ICON, loadIcon(CarbonIcons.SAVE, 16));
		putValue(MEDIUM_ICON, loadIcon(CarbonIcons.SAVE, 24));
		putValue(SHORT_DESCRIPTION, Messages.getString("AbstractSaveAction.ShortDesc"));
		putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_S, InputEvent.ALT_DOWN_MASK + InputEvent.SHIFT_DOWN_MASK));
