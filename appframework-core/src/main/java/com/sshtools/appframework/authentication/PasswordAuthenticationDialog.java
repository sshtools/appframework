 ...
 * 
 * <p> 
 * $Id: PasswordAuthenticationDialog.java,v 1.1.2.1 2010-04-30 22:04:40 brett Exp $
 * </p>
 * <p>
 * Swing dialog that implements {@link SshAuthenticationPrompt} and can be used
 * to request a user name and a password.
 * </p>
 * @author $Author: brett $
 */
...
public class PasswordAuthenticationDialog extends JDialog {
    ...
    private void init() {
        ...
        jButtonOK.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (jTextUsername.getText().trim().equals("")) {
                    JOptionPane.showMessageDialog(PasswordAuthenticationDialog.this, Messages
                        .getString("PasswordAuthenticationDialog.EnterUsername"),
        ...
        UIUtil.jGridBagAdd(userPasswordPanel, new JLabel(Messages.getString("Password")), gbc,
        GridBagConstraints.REMAINDER);
        ...
        UIUtil.jGridBagAdd(userPasswordPanel, message = new JLabel(), gbc,
        GridBagConstraints.REMAINDER);

        // Create the center banner panel

        centerPanel = new IconWrapperPanel(new ResourceIcon(
